export const shapes = [
  ...
  { key: "cushion", label: "Cushion", zh: "长垫形", image: new URL("./assets/shape-cushion.webp", import.meta.url).href, path: "M24 12h52c7 0 12 5 12 12v52c0 7-5 12-12 12H24c-7 0-12-5-12-12V24c0-7 5-12 12-12Zm5 15h42c2 0 4 2 4 4v38c0 2-2 4-4 4H29c-2 0-4-2-4-4V31c0-2 2-4 4-4Zm21-15v76M12 50h76M25 25l50 50M75 25 25 75" },
...
export const diamonds = [
  ...
  { id: "LD-1007", shape: "cushion", carat: 1.92, color: "F", clarity: "SI1", cut: "Good", polish: "Very Good", symmetry: "Good", certificate: "IGI", fluorescence: "Medium", depth: "69.1%", table: "70%", ratio: "1.01", price: 2180, image: "https://images.unsplash.com/photo-1601121141461-9d6647bca1ed?auto=format&fit=crop&w=900&q=85", fast: true, realPhoto: false, createdAt: 5, sold: 61 },
